...
```{r}
data = read_delim("../Data/Liste_Stations.csv")
data %>% count(libelle_cours_eau, sort = TRUE)
write_delim(data %>% count(libelle_cours_eau, sort = TRUE), "../Data/Liste_Stations_CoursEau.csv",
            delim =";")
```
